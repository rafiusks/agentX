  ...
  const envConfig = {
    searchProviders: {
      bing: {
        ...
        timeout: process.env.BING_TIMEOUT ? parseInt(process.env.BING_TIMEOUT) : undefined,
      },
      brave: {
        enabled: process.env.BRAVE_ENABLED !== 'false',
        apiKey: process.env.BRAVE_API_KEY,
        timeout: process.env.BRAVE_TIMEOUT ? parseInt(process.env.BRAVE_TIMEOUT) : undefined,
      },
      duckduckgo: {
